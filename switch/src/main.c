...
static const uint8_t DEVICE_UUID[16] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x00 };
static u8_t ON = 1;
static u8_t OFF = 0;
static u8_t tid = 0;
...
static const struct bt_mesh_model_op opcodes[] = {
